...
public class Pack {
    ...
    public Pack(String typePack, double montantPack, int dureePack, String descriptionPack, int placesPack, int disponibilitePack) {
    ...
    public String toString() {
        return "Pack{" + "id=" + id + ", typePack=" + typePack + ", montantPack=" + montantPack + ", dureePack=" + dureePack + ", descriptionPack=" + descriptionPack + ", placesPack=" + placesPack + ", disponibilitePack=" + disponibilitePack + '}';
    }
